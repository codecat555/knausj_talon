...
# changed 'word' to 'term' for fidgetingbits vim support
term <user.word>: user.insert_formatted(user.word, "NOOP")
...
nixit | nope that | scratch that: user.clear_last_phrase()
