...
(inside parens | args) | round pair: user.insert_between("(", ")")
inside (squares | square brackets | list) | square pair: user.insert_between("[", "]")
inside (bracket | braces) | curly pair: user.insert_between("{", "}")
inside percent: user.insert_between("%", "%")
inside (quotes | string) | string pair: user.insert_between("'", "'")
inside (double quotes | dubquotes) | dub pair: user.insert_between('"', '"')
inside (graves | back ticks): user.insert_between("`", "`")
inside (angles) | angle pair: user.insert_between("<", ">")
angle that:
